...
@section('content')
<form id="login_form" class="bg-[rgba(255,255,255,0.1)] backdrop-blur w-100 flex flex-col gap-3 p-5 rounded">
    ...
    <div class="flex items-center justify-between mt-1">
        ...
        <a href="/forgot-password" class="text-sm text-blue-600 hover:text-blue-500 font-medium transition-colors">
            Forgot password?
        </a>
    </div>
    ...
    <div class="relative mt-4">
        <button type="submit"
            class="login-btn bg-gray-800 flex items-center justify-center gap-2 w-full px-4 py-3 border-none text-white text-lg font-bold rounded-2xl cursor-pointer">
    ...
    <p class="text-center text-gray-600 mt-3">
        ...
        <a class="text-blue-600 hover:text-blue-500 font-semibold transition-colors" href="/signup">Sign up here</a>
    </p>
</form>
